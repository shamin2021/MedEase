...
const ListSelfAssessmentComponenttest= () => {

    const [selfassessments, setSelfAssessments] = useState([]);

    const deleteSelfAssessment = (id) => {
        SelfAssessmentService.deleteSelfAssessment(id).then((res) => {
            setSelfAssessments(selfassessments.filter((selfassessment) => selfassessment.id !== id));
        });
    };
...
export default ListSelfAssessmentComponenttest;
