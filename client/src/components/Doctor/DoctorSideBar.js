                ...
                <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-white sm:translate-x-0 dark:bg-blue-50 " aria-label="Sidebar">
                    <div class="h-full flex flex-col justify-between pt-6 px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-0">
                        <ul class="space-y-2 font-medium">
                            <li>
                                <a href="/Doctor" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-black hover:bg-gray-100 dark:hover:bg-blue-100 group">
                            ...
                            <li>
                                <a href="/ManagePatient" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-black hover:bg-gray-100 dark:hover:bg-blue-100 group">
                            ...
                            <li>
                                <a href="/DoctorMeetings" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-black hover:bg-gray-100 dark:hover:bg-blue-100 group">
                        ...
                        <ul class="mt-auto">
                            <li>
                                <a href="DoctorSetting" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-black hover:bg-gray-100 dark:hover:bg-blue-100 group">
