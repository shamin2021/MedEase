...
import { FiMenu, FiHome, FiUser, FiSettings, FiVideo, FiCalendar, FiFileText } from "react-icons/fi";
    ...
    return (
        ...
        >
            <Flex p="5%" flexDir="column" as="nav" alignItems={navSize === "small" ? "center" : "flex-start"}>
                ...
                <NavItem navSize={navSize} icon={FiFileText} title="Self Assessment" href={"/SelfAssessments"} />
