        ...
        <div className=" md:w-3/4 h-3/4 flex py-1 mx-auto bg-white m-5 mt-[7%] p-5">
          <div className="md:w-3/4 mx-auto flex rounded-2xl py-1 p-5">
            <div className="parent md:w-full h-3/4 flex rounded-md pb-2 py-1 bg-white m-3 mt-[7%] p-5">
              <div className="md:w-1/2 mt-2 mb-4">
                <div className=" mx-auto">
                  <img
                    htmlFor="select-image"
                    src={logo}
                    className="mx-auto p-1 h-[300px] w-[250px] rounded-xl"
                  />
                </div>
                <div className="container horizontal justify-center py-1">
                  ...
                  <div className="md:w-1/2 flex mx-auto justify-center p-1 rounded-md mt-3 text-stone-800- text-[17px] font-semibold bg-primary">
                    Message
                  </div>
                </div>
              </div>
                ...
                <div className="container horizontal justify-center py-1">
                  <div className="parent mx-auto">
                    <div className="">
                      ...
                      <div className="text-[17px] font-semibold">X</div>
                      <hr className=""></hr>
                    </div>
                    <div className="mt-2">
                      <div className="text-[17px] text-[#797878]">PHM Area</div>
                      <div className="text-[17px]">X</div>
                      <hr className=""></hr>
                    </div>
                    <div className="mt-2">
