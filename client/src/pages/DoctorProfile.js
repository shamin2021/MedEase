      ...
      <div class="p-4 sm:ml-64">
        <div class="p-4 rounded-lg mt-2 ">
          <div class="flex items-center justify-center h-88 mb-4 rounded background-color: #DCECF8;">
            ...
            <div className="w-full h-screen bg-primary py-1">

{/* 
              <div className=" md:w-3/4 h-3/4 flex py-1 mx-auto rounded-md bg-white m-5 mt-[5%] p-5">
                <div className="md:w-3/4 mx-auto h-3/4 flex rounded-2xl py-1 p-5 mt-[5%]">
                  ...
                  <div className="parent md:w-full flex rounded-lg pb-2 py-1 bg-white m-3 mt-0 h-full p-5">
              ...
              <div class=" w-full flex grid mb-8 rounded-lg shadow-sm md:mb-12 md:grid-cols-2 mt-10 ">

                <figure class="flex flex-col items-center justify-center p-8 text-center bg-white rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:border-r ">
                  <blockquote class="w-full flex justify-center lg:mb-8 ">
                ...
                <figure class="flex flex-col items-center justify-center p-8 text-center bg-white rounded-tr-lg ">
                  <blockquote class="w-full flex justify-center mb-4 lg:mb-8 ">
