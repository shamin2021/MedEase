    ...
    <>
      <div className="grid min-h-full place-items-center bg-white px-auto py-auto sm:py-32 lg:px-8 text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Link to={"/home"} className='rounded-md px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 bg-indigo-500 hover:bg-indigo-800'>Go back home</Link>
