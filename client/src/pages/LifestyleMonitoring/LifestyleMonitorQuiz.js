  ...
  return (
    <GridItem colSpan={6}>
      <div className=" py-1 bg-primary">
        <div className="flex h-screen w-3/4 mx-auto mt-[5%]">
                  ...
                  <TabPanel padding={2}>
                    <div>
                      ...
                      <div className=" text-right">
                        <button className="bg-secondary text-[18px] w-1/5 rounded-md p-2 text-[#ffffff] font-semibold mt-3 ">
                          Next
                        </button>
                      </div>
                    </div>
          ...
          <div className="h-3/4 w-1/4 m-3 bg-white mt-5 rounded-md p-5 m-3">
            ...
            <div className="h-3/4 m-3">
              ...
              <div className=" mt-4">
                <div className="m-1">
                  <div className="text-[18px] font-poppins m-1">Diet</div>
                  <Progress value={70} height="10px" rounded="5px" />
                </div>
                <div className="m-1">
                  <div className="text-[18px] font-poppins m-1 mt-2">
                    Exercise
                  </div>
